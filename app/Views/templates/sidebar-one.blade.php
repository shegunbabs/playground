...
<div x-data="{ mobileSidebarOpen: false, profileDropdownOpen: false }">
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        <!-- Sidebar component, swap this element with another sidebar if you like -->
        <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r bg-orange-600 px-6">
            <div class="flex h-16 shrink-0 items-center">
                    ...
                    <li>
                        <ul role="list" class="-mx-2 space-y-1">
                            <li>
                                ...
                                <a href="#" class="bg-orange-700 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold text-white">
                                    <svg class="h-6 w-6 shrink-0 text-orange-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                                    </svg>
                                    Dashboard
                                </a>
                            ...
                            <li>
                                <div x-data="{  open: false }">
                                    <button @click="open = !open" type="button" class="hover:bg-orange-50 flex items-center w-full text-left rounded-md p-2 gap-x-3 text-sm leading-6 font-semibold text-gray-700" aria-controls="sub-menu-2" aria-expanded="false">
                                    ...
                                    <ul x-show="open" x-transition x-cloak class="mt-1 px-2" id="sub-menu-2">
                                        <li>
                                            <!-- 44px -->
                                            <a href="#" class="hover:bg-orange-50 block rounded-md py-2 pr-2 pl-9 text-sm leading-6 text-gray-50">GraphQL API</a>
                                        </li>

                                        <li>
                                            <!-- 44px -->
                                            <a href="#" class="hover:bg-orange-50 block rounded-md py-2 pr-2 pl-9 text-sm leading-6 text-white">iOS App</a>
                                        </li>

                                        <li>
                                            <!-- 44px -->
                                            <a href="#" class="hover:bg-orange-50 block rounded-md py-2 pr-2 pl-9 text-sm leading-6 text-orange-700">Android App</a>
                                        </li>

                                        <li>
                                            <!-- 44px -->
                                            <a href="#" class="hover:bg-orange-50 block rounded-md py-2 pr-2 pl-9 text-sm leading-6 text-orange-700">New Customer Portal</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
